...
public class HttpControllerTest {
    ...
    //body의 text값을 받을때는 @RequestBody 어노테이션을 셋팅 한다 postman에서 text로 테스트를 할때는 body에서 raw를 선택 하고 테스트 한다. raw선택시에는 가장 우측에 Text, JavaScript, JSON, HTML, XML중 선택 하여 할수 있다. 통상적으로 JSON사용.
