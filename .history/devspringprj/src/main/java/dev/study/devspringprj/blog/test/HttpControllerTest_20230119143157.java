...
public class HttpControllerTest {
    ...
    //postman에 body에서 x-www-form-urlencoded 방식은 html에서 <form></form>테그를 사용하는것과 같다.
    //body의 text값을 받을때는 @RequestBody 어노테이션을 셋팅 한다 postman에서 text로 테스트를 할때는 body에서 raw를 선택 하고 테스트 한다.
